...
abstract class IAuthFacade{
  ...
  Future<Either<String,UserModel>> createUser({required String email});
  ...
  Future<Either<String,PasscodeResponse>> passcodeLogin({required String email_id, required String user_id});
